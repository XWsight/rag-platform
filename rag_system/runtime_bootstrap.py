...
class LocalDurableRuntimeProfile:
    ...
    def build_components(
        ...
        *,
        ...
        return build_local_durable_components(
            settings,
            provider_factory=provider_factory,
            service_builder=build_service_from_settings,
            snapshot_store_factory=SqliteJobSnapshotStore,
        )
    ...
    def readiness_probes(
        ...
        return local_durable_readiness_probes(components, principals)
